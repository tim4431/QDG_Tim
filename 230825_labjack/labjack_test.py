...
rateUS = rate * 1000
timestampFormat = (
    "%Y-%m-%d %I:%M:%S.%f"  # year-month-day hour:minute:second.microsecond
)
...
print(
    "Reading %s %i times and saving data to the file:\n - %s\n"
...
while curIteration < numIterations:
    try:
        ...
        # Print the results
        print(
            "%s reading: %f V, duration: %0.1f ms, skipped intervals: %i"
