...
cr_instance = TimeTagger.Countrate(
    tagger, [1, 2]
)  # read channel 1 countrate, could be [0,1,2, ..]
...
bin_width = 1e-9
num_bin = 100
corr_instance = TimeTagger.Correlation(
    tagger, 1, 2, bin_width * 1e12, num_bin
)  # measuring correlation btw channel 0,1
