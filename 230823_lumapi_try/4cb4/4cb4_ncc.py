...
if __name__ == "__main__":
    ...
    T_theo = analysis.gaussian_curve(l * 1e-6, 1326e-9, 60e-9) * maxT
    ax.plot(l * 1e3, T_theo, c="red", label="Gaussian_1326_60", alpha=0.4)
    plt.legend()
    #
    plt.savefig("4cb4_ncc.png", bbox_inches="tight", dpi=200)
    plt.show()
